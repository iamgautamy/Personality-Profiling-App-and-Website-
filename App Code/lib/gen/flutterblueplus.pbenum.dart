...
//
// @dart = 2.12
// ignore_for_file: annotate_overrides,camel_case_types,unnecessary_const,non_constant_identifier_names,library_prefixes,unused_import,unused_shown_name,return_of_invalid_type,unnecessary_this,prefer_final_fields, constant_identifier_names, depend_on_referenced_packages
...
class BluetoothState_State extends $pb.ProtobufEnum {
  static const BluetoothState_State UNKNOWN = BluetoothState_State._(
      0,
  ...
  static const BluetoothState_State UNAVAILABLE = BluetoothState_State._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNAVAILABLE');
  static const BluetoothState_State UNAUTHORIZED = BluetoothState_State._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNAUTHORIZED');
  static const BluetoothState_State TURNING_ON = BluetoothState_State._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'TURNING_ON');
  static const BluetoothState_State ON = BluetoothState_State._(4,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ON');
  static const BluetoothState_State TURNING_OFF = BluetoothState_State._(
      5,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'TURNING_OFF');
...
class BluetoothDevice_Type extends $pb.ProtobufEnum {
  static const BluetoothDevice_Type UNKNOWN = BluetoothDevice_Type._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNKNOWN');
  static const BluetoothDevice_Type CLASSIC = BluetoothDevice_Type._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'CLASSIC');
  static const BluetoothDevice_Type LE = BluetoothDevice_Type._(2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'LE');
  static const BluetoothDevice_Type DUAL = BluetoothDevice_Type._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DUAL');
