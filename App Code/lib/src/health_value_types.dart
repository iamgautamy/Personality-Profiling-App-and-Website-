...
class NumericHealthValue extends HealthValue {
  ...
  bool operator ==(Object other) {
    return other is NumericHealthValue && _numericValue == other.numericValue;
  }
...
class AudiogramHealthValue extends HealthValue {
  ...
  @override
  bool operator ==(Object other) {
    return other is AudiogramHealthValue &&
        listEquals(_frequencies, other.frequencies) &&
        listEquals(_leftEarSensitivities, other.leftEarSensitivities) &&
        listEquals(_rightEarSensitivities, other.rightEarSensitivities);
  }
...
class WorkoutHealthValue extends HealthValue {
  ...
  @override
  bool operator ==(Object other) {
    return other is WorkoutHealthValue &&
